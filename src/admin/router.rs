...
use super::{
    handlers::{
        ...
        check_rate_limit, check_update, clear_concurrency, clear_throttle, complete_social_login,
        ...
        get_all_credentials, get_compact_threshold, get_credential_balance,
        get_credential_models, get_endpoint_policy, get_global_proxy,
...
pub fn create_admin_router(state: AdminState) -> Router {
    ...
    let authenticated = Router::new()
        ...
        .route(
            "/credentials/{id}/clear-concurrency",
            post(clear_concurrency),
        )
        ...
        .route("/credentials/{id}/warmup", post(warmup_credential))
        ...
        .route(
            ...
            get(get_compact_threshold).put(set_compact_threshold),
        )
        .route(
